      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            ...
            <h3 class="section-subheading text-muted">Login with your email id and password.</h3>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-6">
            <form id="contactForm" name="sentMessage" novalidate>
              <div class="row">
                <div class="col-lg-6">
                  ...
                  <div class="form-group">
                    <input class="form-control" id="password" type="tel" placeholder="Your Password *" required data-validation-required-message="Please enter your password.">
                    <p class="help-block text-danger"></p>
                  </div>
                </div>
